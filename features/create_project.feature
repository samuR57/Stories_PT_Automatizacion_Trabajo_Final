...
@US1_FS1_TC1 @login @deleteFirstProject @functional @regression
...
@US1_FS1_TC2 @login @deleteFirstProject @regression
...
@US1_FS1_TC3 @login @deleteFirstProject @regression
