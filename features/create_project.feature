...
@US1_FS1_TC1 @login @deleteFirstProject @functional @regression @PS
...
@US1_FS1_TC2 @login @deleteFirstProject @regression @SS
...
@US1_FS1_TC3 @login @deleteFirstProject @regression @SS
