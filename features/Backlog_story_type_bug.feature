...
@US1_FS02_TC8 @login @createFirstProject @deleteFirstProject @functional @validation
...
@US1_FS02_TC9 @login @createFirstProject @addAMemberToProject @deleteFirstProject @functional @verification
...
@US1_FS02_TC10 @login @createFirstProject @createBugStory @deleteFirstProject @functional
...
@US1_FS02_TC11 @login @createFirstProject @deleteFirstProject @functional @boundary
...
@US1_FS02_TC12 @login @createFirstProject @deleteFirstProject @functional @performance
...
@US1_FS02_TC13 @login @createFirstProject @deleteFirstProject @negative @usability
...
@US1_FS02_TC14 @login @createFirstProject @deleteFirstProject @functional @boundary
