...
@US1_FS02_TC17 @login @createFirstProject @deleteFirstProject @functional @regression @PS
...
@US1_FS02_TC18 @login @createFirstProject @deleteFirstProject @functional @regression @PS
...
@US1_FS02_TC19 @login @createFirstProject @deleteFirstProject @functional @regression @PS
