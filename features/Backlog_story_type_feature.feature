...
@US1_FS02_TC1 @login @createFirstProject @deleteFirstProject @functional @validation
...
@US1_FS02_TC2 @login @createFirstProject @addAMemberToProject @deleteFirstProject @functional @integration
...
@US1_FS02_TC3 @login @createFirstProject @deleteFirstProject @functional @boundary
...
@US1_FS02_TC4 @login @createFirstProject @deleteFirstProject @functional @performance @boundary
...
@US1_FS02_TC5 @login @createFirstProject @deleteFirstProject @negative @usability
...
@US1_FS02_TC6 @login @createFirstProject @deleteFirstProject @functional @boundary
...
@US1_FS02_TC7 @login @createFirstProject @createFeatureStory @deleteFirstProject @functional
